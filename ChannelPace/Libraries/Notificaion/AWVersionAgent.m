...
#define kUpgradeAlertMessage    @"From ChannelPace App, %d Contacts added to AddressBook."
...
{
    if ([self conditionHasBeenMet] && (APPDELEGATE.contactCount > 0)) {
        ...
        NSString *msg = [NSString stringWithFormat:kUpgradeAlertMessage, APPDELEGATE.contactCount];
